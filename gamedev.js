$( document ).ready(function() {
	...
	$("#goRight-Straight1").click(function() {
		$("#exploreBody").css("background-image", "url('img/GOPR1596.jpg')");
		$("#goRight-Straight1").hide();
		$("#goRight-Straight2").show();
	});

	$("#goRight-Straight2").click(function() {
		$("#exploreBody").css("background-image", "url('img/200013f.jpg')");
	...
	$("#goRight-Right2").click(function() {
		$("#exploreBody").css("background-image", "url('img/lolman.jpg')");
		$("#goRight-Right2").hide();
		$("#goBack").show();
	});
	...
	$("#goLeft1").click(function() {
		$("#exploreBody").css("background-image", "url('img/Fried_Chicken_restaurant2.jpg')");
		$("#goLeft1").hide();
		$("#goLeft2").show();
	});
	...
	$("#goBack").click(function() {
		$("#exploreBody").css("background-image", "url('img/Obamacare.jpg')");
		$("#goBack").hide();
		$("#goRight1").show();
		$("#goLeft1").show();
	});
